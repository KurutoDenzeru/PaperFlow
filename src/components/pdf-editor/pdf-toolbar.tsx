...
export function PDFToolbar({
  ...
  return (
    <TooltipProvider>
      {/* Main Toolbar */}
      <div className={`w-full border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 sticky top-16 z-50 transition-all ${sidebarOpen ? 'sm:mr-0' : 'mr-0'}`}>
